...
$stations = [
    ...
    "La Plagne" => [
        "altitude" => "1250 m - 3250 m",
        "domaine" => "Paradiski (La Plagne + Les Arcs)",
        "popularite" => "⭐⭐⭐⭐",
        "description" => "Station moderne composée de plusieurs villages, idéale pour les familles et les skieurs de tous niveaux.",
        "activites" => ["Ski alpin", "Bobsleigh", "Snowpark", "Raquettes"],
        "prix" => "€€€ (moyen à élevé)",
        "avantages" => ["Très grand domaine skiable", "Infrastructures modernes", "Convient à tous les niveaux"],
        "inconvenients" => ["Moins authentique (stations modernes)", "Affluence en haute saison"],
        "image" => "https://upload.wikimedia.org/wikipedia/commons/5/50/La_Plague_France.jpg"
    ],
    "Courchevel" => [
        "altitude" => "1100 m - 2738 m",
        "domaine" => "Les 3 Vallées",
        "popularite" => "⭐⭐⭐⭐⭐",
        "description" => "Station prestigieuse et luxueuse, faisant partie du plus grand domaine skiable du monde.",
        "activites" => ["Ski alpin", "Heliski", "Shopping de luxe", "Spa"],
        "prix" => "€€€€€ (très élevé)",
        "avantages" => ["Accès au plus grand domaine skiable", "Ambiance haut de gamme", "Pistes variées et nombreuses"],
        "inconvenients" => ["Prix très élevés", "Image élitiste"],
        "image" => "https://upload.wikimedia.org/wikipedia/commons/a/ab/Courchevel_1850.jpg"
    ]
];
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Stations de ski - Haute-Savoie & Savoie</title>
    <style>
...
<h1>Stations de ski en Haute-Savoie & Savoie</h1>
