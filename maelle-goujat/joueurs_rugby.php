<?php
// --------------------
// PHP : Connexion et traitement formulaire
// --------------------
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ajouter'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $message = "<div class='alert alert-danger mt-3'>Erreur : " . $conn->error . "</div>";
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="tab-pane fade" id="joueurs" role="tabpanel">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<thead class='table-dark'><tr>
                        <th>Nom</th><th>Poste</th><th>DC (kg)</th>
                        <th>Squat (kg)</th><th>Soulevé de terre (kg)</th>
                      </tr></thead><tbody>";
