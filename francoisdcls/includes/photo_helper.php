...
function cached_image_url(string $remoteUrl): ?string {
  ...
  fclose($temp);
  if (empty($data) || strlen($data) < 100) return null;
  ...
  if (@file_put_contents($tmpFile, $data) === false) return null;
