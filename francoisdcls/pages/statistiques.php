...
$sql2 = "SELECT e.nom_ecuries as nom, COUNT(pa.participation_id) as nb_particip FROM ecuries e JOIN participations pa ON e.ecurie_id = pa.ecurie_id GROUP BY e.ecurie_id ORDER BY nb_particip DESC, nom LIMIT 5";
